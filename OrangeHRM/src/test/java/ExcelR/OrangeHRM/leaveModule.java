...
public class leaveModule {
	...
	public static void main(String[] args) throws IOException {
		...
		login.click();
		WebElement pmi = driver.findElement(By.xpath(p.getProperty("leave")));
		pmi.click();

		driver.findElement(By.xpath(p.getProperty("leaveApply"))).click();
		WebElement typ = driver.findElement(By.xpath(p.getProperty("leaveType")));
		typ.click();
		 Actions actions = new Actions(driver);
		 actions.moveToElement(typ).perform();
	}
