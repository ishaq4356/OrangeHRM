...
public class MaintainanceModule {
	...
	public static void main(String[] args) throws IOException {
		...
		login.click();
		WebElement Maintenance = driver.findElement(By.xpath(p.getProperty("Maintenance")));
		Maintenance.click();
		WebElement password1 = driver.findElement(By.xpath(p.getProperty("pass")));
